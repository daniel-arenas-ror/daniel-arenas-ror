...
🔗 Built integrations with Google Calendar, Zoom, payment providers, and REST APIs
🧪 Strong focus on TDD (RSpec, FactoryBot) and Clean Code
🚀 Used CI/CD pipelines (GitHub Actions) to automate deployments and improve team velocity
☁️ Cloud experience with AWS, Kubernetes, DigitalOcean, Heroku
🧠 Passionate about using AI tools to speed up development, refactoring, architecture and debugging
🌱 Always learning — currently improving my English and exploring new technologies
🏆 Highlighted Experience
🏠 laHaus — Senior Ruby on Rails Developer (2022–Present)
...
Increased meeting attendance from 30% to 60%
Scaled to 1,000+ weekly meetings
...
Increased test coverage from 0% to 20%
...
Proactive, ownership-driven, and collaborative
Passion for clean, scalable architecture
...
<!--
**daniel-arenas-ror/daniel-arenas-ror** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
